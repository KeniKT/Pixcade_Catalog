        ...
        <div class="profile-section">
            <div id="profile-picture-text-section">
                <div id="profile-image-bg">
                    <img id="profile-image-large" src="../../public/assets/images/logos/Rectangle 25.png">
                </div>
                <div id="profile-info">
                    <p id="profile-name">Username</p>
                    <p id="account-type">Developer</p>
                    <p id="about-text">About</p>
                </div>
            </div>
            <div id="edit-profile-buton">
                <a id="edit-link" href="./profile_edit.php">Edit Profile</a>
            </div>
        </div>

        <div class="h2-left">
            <h2>My Releases</h2>
            <a id="edit-link" href="./game_add_edit.php">Add Game</a>
        </div>
